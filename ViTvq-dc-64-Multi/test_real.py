...
def test_real():
    ...
    print("=" * 40)
    print(f"开始 VQ-ViT 支路真实环境测试 (Real Transmission Chain)")
    ...
    checkpoint_path = os.path.join("/workspace/yi/work/ViTvq-dc-64-Multi/checkpoints/best_vq_deepsc.pth")
...
def evaluate_metrics_with_channel(model, loader, num_embeddings_list, target_snr, ldpc_code, device):
    """包含完整物理层链路的 MS-SSIM 和 PSNR 联合评估 (VQ-ViT版本)"""
