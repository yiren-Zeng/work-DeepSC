...
CHECKPOINT="${CHECKPOINT:-${VR_EVAL_PROJECT_ROOT}/checkpoints/${VR_EVAL_FAMILY}_stage3_variable_rate/best_variable_rate_raq.pth}"
...
vr_eval_prepare "stage3_variable_rate" "$CHECKPOINT" "variable_rate" "$PROFILES"
