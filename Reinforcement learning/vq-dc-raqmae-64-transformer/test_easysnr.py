...
from communications.ldpc_coding import indices_to_bits, bits_to_indices
...
def test():
    ...
    checkpoint_path = os.path.join("/home/yi/wk-1/vq-dc-raqmae-64-transformer/checkpoints/vq_deepsc_epoch_80.pth")
