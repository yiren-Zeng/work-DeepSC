#!/bin/bash
# Rate-0.083 A/Baseline: SimVQ patch-wise, large-to-small codebooks [32,16], res blocks 6/6.
set -euo pipefail
...
export SIMVQ_EXP_FAMILY="quality_v2_B_larger_rate083_A_patch_cb32-16_res6-6"
export SIMVQ_NUM_EMBEDDINGS_LIST="32,16"
...
# export SIMVQ_PRETRAINED_CHECKPOINT="checkpoints/quality_v2_B_larger_cb32-16_unet2_ds8x2_k32-16/best_vq_deepsc.pth"
...
RUN_ID="exp12_rate083_A_patch_cb32-16_res6-6-$(date +%Y%m%d-%H%M%S)"
...
echo "Test transmission ratio (LDPC1/2+BPSK): 0.08333333"
