#!/bin/bash
# Rate-0.047 A/Baseline: SimVQ patch-wise, large-to-small codebooks [16,4], res blocks 6/6.
set -euo pipefail
...
export SIMVQ_EXP_FAMILY="quality_v2_B_larger_rate047_A_patch_cb16-4_res6-6"
...
RUN_ID="exp12_rate047_A_patch_cb16-4_res6-6-$(date +%Y%m%d-%H%M%S)"
