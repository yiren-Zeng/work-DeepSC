#!/bin/bash
# Rate-0.125 A/Baseline: SimVQ patch-wise, large-to-small codebooks [2048,16], res blocks 6/6.
set -euo pipefail
...
export SIMVQ_EXP_FAMILY="quality_v2_B_larger_rate125_A_patch_cb2048-16_res6-6"
export SIMVQ_NUM_EMBEDDINGS_LIST="2048,16"
...
# Guarantee that this experiment starts without weights from any prior scheme.
...
RUN_ID="exp12_rate125_A_patch_cb2048-16_res6-6-$(date +%Y%m%d-%H%M%S)"
...
echo "Test transmission ratio (LDPC1/2+BPSK): 0.12500000"
