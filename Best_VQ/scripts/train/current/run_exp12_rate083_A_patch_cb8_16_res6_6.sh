#!/bin/bash
# Rate-0.083 A/Baseline: SimVQ patch-wise, large-to-small codebooks [8,16], res blocks 6/6.
set -euo pipefail
...
# export SIMVQ_PRETRAINED_CHECKPOINT="checkpoints/quality_v2_B_larger_cb8-16_unet2_ds8x2_k8-16/best_vq_deepsc.pth"
...
RUN_ID="exp12_rate083_A_patch_cb8-16_res6-6-$(date +%Y%m%d-%H%M%S)"
