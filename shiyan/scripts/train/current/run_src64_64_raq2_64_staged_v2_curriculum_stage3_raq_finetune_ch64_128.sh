...
STAGE2_CKPT="checkpoints/shiyan_raq_src64-64_raq2-64_staged_v2_curriculum_stage2_raq_warmup_rate044_A_patch_ch64-128_unet2_ds8x2_k64/best_vq_deepsc.pth"
...
RUN_ID="staged_v2_src64-64_stage3_raq_finetune_ch64-128_gpu${GPU_ID}-$(date +%Y%m%d-%H%M%S)"
