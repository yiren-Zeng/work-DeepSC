...
STAGE3_CKPT="checkpoints/shiyan_raq_src64-64_raq2-64_staged_curriculum_stage3_raq_finetune_rate044_A_patch_ch64-128_unet2_ds8x2_k64/best_vq_deepsc.pth"

export SIMVQ_EXPERIMENT_STAGE="B"
export SIMVQ_EXP_FAMILY="shiyan_raq_src64-64_raq2-64_staged_curriculum_stage4_raq_channel_rate044_A_patch_ch64-128"
...
RUN_ID="staged_src64-64_stage4_raq_channel_ch64-128_gpu${GPU_ID}-$(date +%Y%m%d-%H%M%S)"
