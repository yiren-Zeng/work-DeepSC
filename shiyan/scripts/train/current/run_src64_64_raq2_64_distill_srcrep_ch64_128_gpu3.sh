...
export SIMVQ_EXP_FAMILY="shiyan_raq_src64-64_raq2-64_distill_srcrep_rate044_A_patch_ch64-128"
...
export SIMVQ_SRC_CODEBOOK_REPULSION_WEIGHT="${SIMVQ_SRC_CODEBOOK_REPULSION_WEIGHT:-0.0005}"
export SIMVQ_SRC_CODEBOOK_REPULSION_MARGIN="${SIMVQ_SRC_CODEBOOK_REPULSION_MARGIN:-0.5}"
export SIMVQ_SRC_CODEBOOK_REPULSION_NORMALIZE="${SIMVQ_SRC_CODEBOOK_REPULSION_NORMALIZE:-1}"
export SIMVQ_SRC_CODEBOOK_REPULSION_WARMUP_START_EPOCH="${SIMVQ_SRC_CODEBOOK_REPULSION_WARMUP_START_EPOCH:-5}"
export SIMVQ_SRC_CODEBOOK_REPULSION_WARMUP_END_EPOCH="${SIMVQ_SRC_CODEBOOK_REPULSION_WARMUP_END_EPOCH:-20}"
...
RUN_ID="src64-64_raq2-64_distill_srcrep_ch64-128_gpu${GPU_ID}-$(date +%Y%m%d-%H%M%S)"
...
echo "SRC codebook repulsion margin: $SIMVQ_SRC_CODEBOOK_REPULSION_MARGIN"
echo "SRC codebook repulsion normalize: $SIMVQ_SRC_CODEBOOK_REPULSION_NORMALIZE"
echo "SRC codebook repulsion warmup: [$SIMVQ_SRC_CODEBOOK_REPULSION_WARMUP_START_EPOCH,$SIMVQ_SRC_CODEBOOK_REPULSION_WARMUP_END_EPOCH]"
