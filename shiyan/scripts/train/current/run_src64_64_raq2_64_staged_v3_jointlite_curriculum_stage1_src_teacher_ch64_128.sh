...
export SIMVQ_EXP_FAMILY="shiyan_raq_src64-64_raq2-64_staged_v3_jointlite_curriculum_stage1_src_teacher_rate044_A_patch_ch64-128"
...
unset SIMVQ_SRC_CODEBOOK_ANCHOR_CHECKPOINT
...
RUN_ID="staged_v3_src64-64_stage1_src_teacher_ch64-128_gpu${GPU_ID}-$(date +%Y%m%d-%H%M%S)"
