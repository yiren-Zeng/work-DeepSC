...
STAGE1_CKPT="checkpoints/shiyan_raq_src64-64_raq2-64_staged_curriculum_stage1_src_teacher_rate044_A_patch_ch64-128_unet2_ds8x2_k64/best_vq_deepsc.pth"

export SIMVQ_EXPERIMENT_STAGE="B"
export SIMVQ_EXP_FAMILY="shiyan_raq_src64-64_raq2-64_staged_curriculum_stage2_raq_warmup_rate044_A_patch_ch64-128"
export SIMVQ_TRAIN_BRANCH="raq_warmup"
...
export SIMVQ_RAQ_LATENT_DISTILL_WEIGHT="${SIMVQ_RAQ_LATENT_DISTILL_WEIGHT:-1.00}"
...
RUN_ID="staged_src64-64_stage2_raq_warmup_ch64-128_gpu${GPU_ID}-$(date +%Y%m%d-%H%M%S)"
...
echo "Pretrained SRC teacher: $SIMVQ_PRETRAINED_CHECKPOINT"
...
echo "Channel curriculum disabled in Stage 2 via [$SIMVQ_CHANNEL_PROB_START_EPOCH,$SIMVQ_CHANNEL_PROB_END_EPOCH]"
