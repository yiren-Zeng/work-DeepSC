...
export SIMVQ_EXP_FAMILY="shiyan_raq_dualsrc16-64_raq2-64_baseline_curriculum_raq_decoder_only_rate044_A_patch_ch64-128"
...
export SIMVQ_RAQ_GENERATOR_TYPE="decoder_only"
export SIMVQ_RAQ_ROUTED_SRC_ENABLED="1"
export SIMVQ_RAQ_ROUTED_SRC_THRESHOLD="16"
export SIMVQ_RAQ_ROUTED_SRC_SMALL_LIST="16,16"
export SIMVQ_RAQ_ROUTED_SRC_LARGE_LIST="64,64"
...
RUN_ID="src64-64_dualsrc16-64_raq2-64_baseline_curriculum_raq_decoder_only_ch64-128_gpu${GPU_ID}-$(date +%Y%m%d-%H%M%S)"
...
echo "Large source codebooks: $SIMVQ_RAQ_ROUTED_SRC_LARGE_LIST"
echo "Small source codebooks: $SIMVQ_RAQ_ROUTED_SRC_SMALL_LIST"
echo "RAQ route: K<=${SIMVQ_RAQ_ROUTED_SRC_THRESHOLD} uses small source, otherwise large source"
echo "RAQ generator type: $SIMVQ_RAQ_GENERATOR_TYPE"
