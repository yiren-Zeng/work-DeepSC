...
export SIMVQ_NUM_EMBEDDINGS_LIST="65536,65536"
...
RUN_ID="rate044_A_patch_cb16-2_ch512-1024-$(date +%Y%m%d-%H%M%S)"
...
#
# pdb 调试：
#   DEBUG_PDB=1 bash scripts/train_xxx.sh
#
# VSCode debugpy 调试，不等待 VSCode 连接：
#   DEBUGPY=1 bash scripts/train_xxx.sh
#
# VSCode debugpy 调试，等待 VSCode attach：
#   DEBUGPY=1 DEBUGPY_WAIT=1 bash scripts/train_xxx.sh
#
# 指定 debugpy 端口：
#   DEBUGPY=1 DEBUGPY_PORT=5678 bash scripts/train_xxx.sh
# ============================================================
