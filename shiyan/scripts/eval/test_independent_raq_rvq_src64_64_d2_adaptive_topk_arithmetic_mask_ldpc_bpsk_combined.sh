#!/bin/bash
# Adaptive arithmetic-coded Top-K masks; combined LDPC 1/2 + BPSK at 0 dB.
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-experiments/eval/independent_raq_rvq_src64_64_d2_adaptive_topk_arithmetic_mask_combined}"
...
echo "Mask: actual adaptive binary arithmetic code, reset per image/scale"
