...
export SIMVQ_EXP_FAMILY="shiyan_independent_raq_rvq_src16-16_trg2-16_d2_curriculum_rate094_A_patch_ch256-512"
export SIMVQ_NUM_EMBEDDINGS_LIST="16,16"
...
export SIMVQ_RAQ_CURRICULUM_EARLY_LIST="16"
export SIMVQ_RAQ_CURRICULUM_MIDDLE_LIST="8,16"
export SIMVQ_RAQ_CURRICULUM_LATE_LIST="2,4,8,16"
...
CHECKPOINT="${CHECKPOINT:-checkpoints/shiyan_independent_raq_rvq_src16-16_trg2-16_d2_curriculum_rate094_A_patch_ch256-512_unet2_ds8x2_k16/best_vq_deepsc.pth}"
SNRS="${SNRS:-6}"
JSON_OUTPUT="${JSON_OUTPUT:-experiments/eval/independent_raq_rvq_src16-16_k4x64-8x2_d2_ldpc34_qpsk_combined.json}"
