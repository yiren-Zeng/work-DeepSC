...
export SIMVQ_EXP_FAMILY="shiyan_independent_raq_rvq_src32-32_trg2-32_d2_curriculum_rate094_A_patch_ch256-512"
export SIMVQ_NUM_EMBEDDINGS_LIST="32,32"
...
export SIMVQ_INDEPENDENT_RAQ_RVQ_K_LISTS="${SIMVQ_INDEPENDENT_RAQ_RVQ_K_LISTS:-32,4;8,2}"
...
export SIMVQ_RAQ_TARGET_LIST="32,32"
export SIMVQ_RAQ_MIN_TRG="2"
export SIMVQ_RAQ_MAX_TRG="32"
...
CHECKPOINT="${CHECKPOINT:-checkpoints/shiyan_independent_raq_rvq_src32-32_trg2-32_d2_curriculum_rate094_A_patch_ch256-512_unet2_ds8x2_k32/best_vq_deepsc.pth}"
SNRS="${SNRS:-10}"
JSON_OUTPUT="${JSON_OUTPUT:-experiments/eval/independent_raq_rvq_src32-32_k4x64-8x2_d2_ldpc34_qpsk_combined.json}"
