#!/bin/bash
# Evaluate the trained strict shared-codebook RAQ-RVQ model at K=[16,4].
set -euo pipefail
...
export SIMVQ_RAQ_TARGET_LIST="${SIMVQ_RAQ_TARGET_LIST:-32,16}"
...
CHECKPOINT="${CHECKPOINT:-checkpoints/shiyan_shared_raq_rvq_src64-64_trg2-64_d2_curriculum_rate094_A_patch_ch256-512_unet2_ds8x2_k64/best_vq_deepsc.pth}"
SNRS="${SNRS:-0 3 6 9 12}"
MODULATION="${MODULATION:-bpsk}"
JSON_OUTPUT="${JSON_OUTPUT:-experiments/eval/shared_raq_rvq_src64-64_k16-4_d2_ldpc_bpsk.json}"
