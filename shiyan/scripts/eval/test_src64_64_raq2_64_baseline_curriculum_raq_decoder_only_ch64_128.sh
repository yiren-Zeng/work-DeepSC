...
export SIMVQ_EXP_FAMILY="shiyan_raq_src64-64_raq2-64_baseline_curriculum_raq_decoder_only_rate044_A_patch_ch64-128"
...
CHECKPOINT="${CHECKPOINT:-checkpoints/shiyan_raq_src64-64_raq2-64_baseline_curriculum_raq_decoder_only_rate044_A_patch_ch64-128_unet2_ds8x2_k64/best_vq_deepsc.pth}"
SNRS="${SNRS:-0}"
