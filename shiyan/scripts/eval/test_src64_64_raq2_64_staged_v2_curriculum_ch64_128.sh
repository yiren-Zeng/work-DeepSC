...
export SIMVQ_RAQ_TARGET_LIST="${SIMVQ_RAQ_TARGET_LIST:-64,64}"
...
CHECKPOINT="${CHECKPOINT:-checkpoints/shiyan_raq_src64-64_raq2-64_staged_v2_curriculum_stage4_raq_channel_rate044_A_patch_ch64-128_unet2_ds8x2_k64/best_vq_deepsc.pth}"
