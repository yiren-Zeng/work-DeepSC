...
# Test-time zero-shot residual RAQ: both RVQ stages reuse the trained single-stage
# RAQ generator.  The second stage was not trained on residual distributions.
