...
CHECKPOINT="${CHECKPOINT:-checkpoints/shiyan_raq_src64-64_raq2-64_staged_v2_curriculum_stage2_raq_warmup_rate044_A_patch_ch64-128_unet2_ds8x2_k64/best_vq_deepsc.pth}"
