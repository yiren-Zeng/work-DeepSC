...
export SIMVQ_EXP_FAMILY="shiyan_raq_src64-64_raq2-64_curriculum_rate044_A_patch_ch256-512"
...
export SIMVQ_RAQ_TARGET_LIST="${SIMVQ_RAQ_TARGET_LIST:-,}"
...
CHECKPOINT="${CHECKPOINT:-checkpoints/shiyan_raq_src64-64_raq2-64_curriculum_rate044_A_patch_ch256-512_unet2_ds8x2_k64/best_vq_deepsc.pth}"
SNRS="${SNRS:-0}"
