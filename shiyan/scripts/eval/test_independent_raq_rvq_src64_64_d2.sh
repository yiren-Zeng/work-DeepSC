#!/bin/bash
# Evaluate the trained four-codebook RAQ-RVQ model at a fixed four-K layout.
set -euo pipefail
...
export SIMVQ_INDEPENDENT_RAQ_RVQ_K_LISTS="${SIMVQ_INDEPENDENT_RAQ_RVQ_K_LISTS:-2,2;8,2}"
...
JSON_OUTPUT="${JSON_OUTPUT:-experiments/eval/independent_raq_rvq_src64-64_k16x16-4x4_d2_ldpc_bpsk.json}"
