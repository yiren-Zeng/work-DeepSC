#!/bin/bash
# Evaluate [4,8] as one payload under LDPC 1/2 + 16-QAM.
set -euo pipefail
...
export SIMVQ_INDEPENDENT_RAQ_RVQ_K_LISTS="${SIMVQ_INDEPENDENT_RAQ_RVQ_K_LISTS:-16,16}"
...
export SIMVQ_RAQ_TARGET_LIST="4"
...
SNRS="${SNRS:-10}"
JSON_OUTPUT="${JSON_OUTPUT:-experiments/eval/independent_raq_rvq_src64_unet1_k4x8_d2_ldpc12_16qam_combined.json}"
