...
export SIMVQ_RAQ_SRC_RECON_WEIGHT="0.00"
export SIMVQ_RAQ_SRC_VQ_WEIGHT="0.00"
export SIMVQ_RAQ_CODEBOOK_ANCHOR_WEIGHT="0.00"
...
CHECKPOINT="${CHECKPOINT:-checkpoints/shiyan_raq_src64-64_raq2-64_staged_v3_jointlite_curriculum_stage4_raq_jointlite_channel_rate044_A_patch_ch64-128_unet2_ds8x2_k64/best_vq_deepsc.pth}"
