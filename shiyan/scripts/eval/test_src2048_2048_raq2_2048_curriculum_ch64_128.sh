...
export SIMVQ_EXP_FAMILY="shiyan_raq_src2048-2048_raq2-2048_curriculum_rate044_A_patch_ch64-128"
...
export SIMVQ_RAQ_TARGET_LIST="${SIMVQ_RAQ_TARGET_LIST:-1024,256}"
...
CHECKPOINT="${CHECKPOINT:-checkpoints/shiyan_raq_src2048-2048_raq2-2048_curriculum_rate044_A_patch_ch64-128_unet2_ds8x2_k2048/best_vq_deepsc.pth}"
