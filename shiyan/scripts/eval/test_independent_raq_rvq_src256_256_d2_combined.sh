...
export SIMVQ_INDEPENDENT_RAQ_RVQ_K_LISTS="${SIMVQ_INDEPENDENT_RAQ_RVQ_K_LISTS:-32,64;8,2}"
...
SNRS="${SNRS:-10}"
JSON_OUTPUT="${JSON_OUTPUT:-experiments/eval/independent_raq_rvq_src256-256_k4x64-8x2_d2_ldpc34_qpsk_combined.json}"
