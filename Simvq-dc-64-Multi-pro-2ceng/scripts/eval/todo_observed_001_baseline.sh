...
export SIMVQ_EXP_FAMILY="observed_001_baseline"
export SIMVQ_NUM_EMBEDDINGS_LIST="64,64"
export SIMVQ_DOWNSAMPLE_STRIDES="${SIMVQ_DOWNSAMPLE_STRIDES:-4,2}"
...
"$SCRIPT_DIR/_eval_common.sh" \
  "checkpoints/observed_001_baseline/best_vq_deepsc.pth" "$@"
