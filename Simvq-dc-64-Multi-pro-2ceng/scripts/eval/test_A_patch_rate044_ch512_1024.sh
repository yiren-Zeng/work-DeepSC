...
export SIMVQ_EXP_FAMILY="quality_v2_B_larger_rate044_A_patch_cb16-2_ch512-1024"
...
if [ "$#" -eq 0 ]; then
  "${PYTHON_CMD[@]}" test_real.py \
    --checkpoint checkpoints/quality_v2_B_larger_rate044_A_patch_cb16-2_ch512-1024_unet2_ds8x2_k16-2/best_vq_deepsc.pth \
    --snrs 0 \
    --modulation bpsk
else
  "${PYTHON_CMD[@]}" test_real.py "$@"
