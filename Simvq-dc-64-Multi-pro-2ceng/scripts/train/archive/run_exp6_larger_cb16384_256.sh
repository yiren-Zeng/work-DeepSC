#!/bin/bash
# Stage B larger backbone with codebooks [16384,256].
set -euo pipefail
...
export SIMVQ_EXP_FAMILY="quality_v2_B_larger_cb16384-256"
export SIMVQ_NUM_EMBEDDINGS_LIST="16384,256"
...
RUN_ID="exp6_larger_cb16384-256-$(date +%Y%m%d-%H%M%S)"
...
python -u tools/auto_evaluate_completed_experiments.py \
  --experiment "quality_v2_B_larger_cb16384-256_unet2_ds8x2_k16384-256" \
  --gpu "$GPU_ID"
