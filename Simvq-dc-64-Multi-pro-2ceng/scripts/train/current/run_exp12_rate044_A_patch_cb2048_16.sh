#!/bin/bash
# Rate-0.125 A/Baseline: SimVQ patch-wise, large-to-small codebooks [2048,16].
set -euo pipefail
...
export SIMVQ_EXP_FAMILY="quality_v2_B_larger_rate044_A_patch_cb2048-16"
...
RUN_ID="exp12_rate044_A_patch_cb2048-16-$(date +%Y%m%d-%H%M%S)"
