#!/bin/bash
# Rate-0.044 A/Baseline variant: SimVQ patch-wise [16,2] with channel_prob=1 from epoch 1.
set -euo pipefail
...
export SIMVQ_EXP_FAMILY="quality_v2_B_larger_rate044_A_patch_cb16-2_chprob1"
...
export SIMVQ_CHANNEL_PROB_START_EPOCH="0"
export SIMVQ_CHANNEL_PROB_END_EPOCH="0"
...
RUN_ID="exp12_rate044_A_patch_cb16-2_chprob1-$(date +%Y%m%d-%H%M%S)"
...
echo "Channel prob schedule: always 1 (start=$SIMVQ_CHANNEL_PROB_START_EPOCH end=$SIMVQ_CHANNEL_PROB_END_EPOCH)"
