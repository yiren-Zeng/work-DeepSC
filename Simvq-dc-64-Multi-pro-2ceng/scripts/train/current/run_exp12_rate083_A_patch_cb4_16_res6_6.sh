#!/bin/bash
# Rate-0.083 A/Baseline: SimVQ patch-wise, large-to-small codebooks [4,16], res blocks 6/6.
set -euo pipefail
...
export SIMVQ_EXP_FAMILY="quality_v2_B_larger_rate083_A_patch_cb4-16_res6-6"
export SIMVQ_NUM_EMBEDDINGS_LIST="4,16"
...
# export SIMVQ_PRETRAINED_CHECKPOINT="checkpoints/quality_v2_B_larger_cb4-16_unet2_ds8x2_k4-16/best_vq_deepsc.pth"
...
RUN_ID="exp12_rate083_A_patch_cb4-16_res6-6-$(date +%Y%m%d-%H%M%S)"
