#!/bin/bash
# Rate-0.083 A/Baseline: SimVQ patch-wise, large-to-small codebooks [128,16], res blocks 6/6.
set -euo pipefail
...
export SIMVQ_EXP_FAMILY="quality_v2_B_larger_rate083_A_patch_cb128-16_res6-6"
...
RUN_ID="exp12_rate083_A_patch_cb128-16_res6-6-$(date +%Y%m%d-%H%M%S)"
