#!/bin/bash
# Rate-0.044 A/Baseline: SimVQ patch-wise, large-to-small codebooks [256,2].
set -euo pipefail
...
export SIMVQ_EXP_FAMILY="quality_v2_B_larger_rate044_A_patch_cb256-2"
export SIMVQ_NUM_EMBEDDINGS_LIST="256,2"
...
RUN_ID="exp12_rate044_A_patch_cb256-2-$(date +%Y%m%d-%H%M%S)"
