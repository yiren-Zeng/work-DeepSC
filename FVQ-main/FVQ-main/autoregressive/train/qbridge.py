...
def QBridge_XL_8_02(**kwargs):
    return DiT(depth=2, patch_size=8, head_hidden_size=128, num_heads=4, class_dropout_prob=0.2, **kwargs)
...
QBridge_models = {
    ...
    'QBridge-XL/8-cdp-02': QBridge_XL_8_02,
}
