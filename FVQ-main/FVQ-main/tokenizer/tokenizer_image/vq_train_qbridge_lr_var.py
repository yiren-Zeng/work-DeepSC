...
# from tokenizer.tokenizer_image.vq_model_qbridge_test import VQ_models
from tokenizer.tokenizer_image.var.model.vqvae import VQ_models
...
def main(args):
    ...
    # training args
    logger.info(f"==============================================")
    logger.info(f"======= THIS IS BA-VQ(VAR)'s TRAINING =======")
    logger.info(f"==============================================")
    ...
    vq_model = VQ_models[args.vq_model](
        vocab_size=args.codebook_size, # default 4096
        z_channels=args.codebook_embed_dim, # default 32
    ...
    def combined_lr_lambda(current_step: int):
        ...
        if current_step < warmup_steps:
            ...
            if args.sche_type == 'const':
                return 1.0
            elif args.sche_type == 'lin':
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sche_type", type=str, choices=["lin", "const"], default="lin")
