...
def eval_fid(args, vq_model, data_val, dir_recon):
    vq_model.eval()
...
if __name__ == '__main__':
    ...
    folder_name = '/mnt/dolphinfs/ssd_pool/docker/user/hadoop-automl/changyifan/vision/reconstruction_'
    sample_folder_dir = folder_name + "qbridge-262144" + "/"
    if args.rank == 0:
        os.makedirs(sample_folder_dir, exist_ok=True)
        print(f"Saving .png samples at {sample_folder_dir}")
    
    data_val = '/mnt/dolphinfs/ssd_pool/docker/user/hadoop-automl/changyifan/vision/img_square'
    dir_recon = sample_folder_dir

    eval_fid(args, vq_model, data_val, dir_recon)
