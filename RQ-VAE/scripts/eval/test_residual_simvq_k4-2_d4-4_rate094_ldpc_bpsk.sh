#!/bin/bash
# Real-chain depth-[4,4] Residual-SimVQ evaluation: LDPC rate 1/2 and BPSK.
set -euo pipefail
...
JSON_OUTPUT="${JSON_OUTPUT:-experiments/eval/residual_simvq_k4-2_d4-4_rate094_ldpc_bpsk.json}"
