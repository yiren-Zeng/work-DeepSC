#!/bin/bash
# Real-chain K=[16,4] Residual-SimVQ evaluation: LDPC rate 1/2 and BPSK.
set -euo pipefail
...
JSON_OUTPUT="${JSON_OUTPUT:-experiments/eval/residual_simvq_k16-4_d2-2_rate094_ldpc_bpsk.json}"
