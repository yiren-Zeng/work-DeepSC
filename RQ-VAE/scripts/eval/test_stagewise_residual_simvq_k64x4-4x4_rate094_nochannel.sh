#!/bin/bash
# No-channel reconstruction for stagewise K=[[64,4],[4,4]] Residual-SimVQ.
set -euo pipefail
...
JSON_OUTPUT="${JSON_OUTPUT:-experiments/eval/stagewise_residual_simvq_k64x4-4x4_rate094_nochannel.json}"
