#!/bin/bash
# Clean source reconstruction for the K=[16,4] Residual-SimVQ checkpoint.
set -euo pipefail
...
JSON_OUTPUT="${JSON_OUTPUT:-experiments/eval/residual_simvq_k16-4_d2-2_rate094_nochannel.json}"
