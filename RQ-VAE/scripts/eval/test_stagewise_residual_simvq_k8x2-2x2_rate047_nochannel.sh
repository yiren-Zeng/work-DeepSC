#!/bin/bash
# No-channel reconstruction for stagewise K=[[8,2],[2,2]] Residual-SimVQ.
set -euo pipefail
...
JSON_OUTPUT="${JSON_OUTPUT:-experiments/eval/stagewise_residual_simvq_k8x2-2x2_rate047_nochannel.json}"
