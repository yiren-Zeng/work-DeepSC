#!/bin/bash
# Real-chain stagewise K=[[8,2],[2,2]] evaluation: LDPC rate 1/2 and BPSK.
set -euo pipefail
...
JSON_OUTPUT="${JSON_OUTPUT:-experiments/eval/stagewise_residual_simvq_k8x2-2x2_rate047_ldpc_bpsk.json}"
