...
# Train all four residual stages from scratch; never inherit the depth-2 model.
...
RUN_ID="residual_simvq_k4-2_d4-4_rate094-$(date +%Y%m%d-%H%M%S)"
...
echo "Residual loss: mean over Q1-Q4 plus commitment_cost times mean over C1-C4"
