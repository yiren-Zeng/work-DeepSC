#!/bin/bash
# Fresh Stage-B two-scale stagewise Residual-SimVQ training at 9216 source bits/image.
set -euo pipefail
...
RUN_ID="stagewise_residual_simvq_k64x4-4x4_rate094-$(date +%Y%m%d-%H%M%S)"
export EXPERIMENT_RUN_ID="$RUN_ID"

echo "Experiment: $EXPERIMENT_NAME"
echo "Run ID: $RUN_ID"
echo "GPU: $GPU_ID"
echo "Quantizer: stagewise_residual_simvq, independent K=[[64,4],[4,4]]"
